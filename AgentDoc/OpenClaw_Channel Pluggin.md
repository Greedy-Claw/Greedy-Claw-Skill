# [Building Channel Plugins](#building-channel-plugins)
...
## [How channel plugins work](#how-channel-plugins-work)
...
## [Approvals and channel capabilities](#approvals-and-channel-capabilities)
...
## [Inbound mention policy](#inbound-mention-policy)
...
Fixed, account-scoped, or custom reply modes](/plugins/sdk-entrypoints#registration-mode)

[## Message tool integration

describeMessageTool and action discovery](/plugins/architecture#channel-plugins-and-the-shared-message-tool)

[## Target resolution

inferTargetChatType, looksLikeId, resolveTarget](/plugins/architecture#channel-target-resolution)

[## Runtime helpers

TTS, STT, media, subagent via api.runtime](/plugins/sdk-runtime)
